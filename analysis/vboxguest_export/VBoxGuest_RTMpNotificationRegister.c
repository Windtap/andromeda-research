__int64 __fastcall VBoxGuest_RTMpNotificationRegister(__int64 a1, __int64 a2)
{
  _QWORD *v3; // rax
  __int64 result; // rax
  _QWORD *v5; // rax
...
LABEL_10:
    ...
    {
      *v5 = 0;
      v7 = g_hRTMpNotifySpinLock;
      v5[1] = a1;
      v5[2] = a2;
      v5[3] = -1;
      VBoxGuest_RTSpinlockAcquire(v7);
      i = (__int64 *)g_pRTMpCallbackHead;
      if ( g_pRTMpCallbackHead )
      {
        for ( i = (__int64 *)g_pRTMpCallbackHead; i[2] != a2 || i[1] != a1; i = (__int64 *)*i )
        {
          if ( !*i )
          {
            *i = v6;
