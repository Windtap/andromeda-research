__int64 __fastcall VbglR0HGCMCallUserDataRaw(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  return VbglR0IdcCallRaw(a1 + 8, (a3 << 16) | 0xC0005608, a2, a3);
}
